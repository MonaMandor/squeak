...
import 'package:squeak/features/appointments/user/presentation/widgets/section_title.dart';
import 'package:squeak/features/appointments/user/presentation/widgets/tabel_with_header.dart';
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            if (cubit.invoices!.items.isNotEmpty)
                              SectionTitle(title: isArabic()
                                  ? 'تفاصيل الفاتورة'
                                  : 'Item Details'),
                            if (cubit.invoices!.items.isNotEmpty)
                              SizedBox(height: 5),
                            if (cubit.invoices!.items.isNotEmpty)
                              TabelWithHeader(data: [
                                  [
