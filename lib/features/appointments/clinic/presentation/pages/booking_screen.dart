...
import 'package:squeak/features/appointments/clinic/presentation/widgets/pet_item.dart';
...
import '../../../user/presentation/widgets/CustomCalendarDatePicker.dart';
...
class _BookingScreenState extends State<BookingScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) =>
          ...
          )..getClientINClinic(widget.clinicCode),
                                    ...
                                    ? CarouselSlider.builder(
                                        ...
                                        itemBuilder:
                                          ...
                                          return InkWell(
                                            ...
                                            child: Pet(doctor: petsData[index], cubit: cubit, context: context),
                                          );
                                        },
  ...
  void createAppointmentForPet({
    ...
    ClinicCubit.get(context).createAppointment(
      petId: petId,
  ...
  Future<void> handleCreateAppointment(BuildContext context) async {
    ...
    final clinicCubit = ClinicCubit.get(context);
    ...
    if (ClinicCubit.get(context).clientINClinic) {
      ClientClinicModel? matchedPet;

      if (isPetFromCache) {
        print("yes the pet from cached");
        matchedPet = findPet(clinicCubit.petListInVet, petNameFromCache);
      } else {
        print("no the pet not from cached");
        matchedPet = findPet(clinicCubit.petListInVet, dropDownId!);
      }
        ...
        createAppointmentForPet(
          ...
          petName: isPetFromCache
              ...
              : widget.petNameFromAppoinmentIcon == null
                  ? petName!
                  : widget.petNameFromAppoinmentIcon,
          clientId: ClinicCubit.get(context).petListInVet.firstOrNull?.clientId ?? '',
          isExisted: false,
          notExistedOrPet: false,
          isExistedNoPet: true,
          doctorId: doctorId,
